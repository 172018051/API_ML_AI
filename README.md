...
> 1. 一句话版本<br>有声信可以以别的方式来弥补用户对于书信的期待，运用人工智能**语音识别、自然语言处理**技术，将语音与文字相结合做出一封有声音的书信，同时辅以**交互的UI设计**，最大程度的**保留故事**与**模拟时间给书信带来的痕迹**。这是有声书可以给用户带来的价值。   
...
---   
### 产品介绍：  
有声书运用人工智能语音识别、自然语言处理技术，将语音与文字相结合做出一封有声音的书信，同时辅以交互的UI界面，最大程度的保留故事与模拟时间给书信带来的痕迹。这是有声书可以给用户带来的价值。   
...
### 产品亮点（优势）：    
有声信可以以别的方式来弥补用户对于书信的期待，运用人工智能**语音识别、自然语言处理**技术，将语音与文字相结合做出一封有声音的书信，同时辅以**交互的UI设计**，最大程度的**保留故事**与**模拟时间给书信带来的痕迹**。这是有声书可以给用户带来的价值。
